...
it('should show page title', async () => {
    ...
    const container = await renderClassStateTodoPage(stubTodoRepo)


    await wait(() => expect(container).toHaveTextContent('Todo List (Class/State)'))
})
...
describe('Adding a todo', () => {
    ...
    beforeEach(async () => {
        ...
        container = await renderClassStateTodoPage(stubTodoRepo)
...
function renderClassStateTodoPage(todoRepo: TodoRepo) {
    /**
     * NOTE:
     ...
     */
    return renderRoutesAtPath('/class-state', {todoRepo})
}