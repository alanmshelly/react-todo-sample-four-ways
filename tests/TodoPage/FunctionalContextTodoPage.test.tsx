...
it('should show page title', async () => {
    ...
    const container = await renderFunctionalContextTodoPage(stubTodoRepo)


    await wait(() => expect(container).toHaveTextContent('Todo List (Functional/Context)'))
})
...
describe('Adding a todo', () => {
    ...
    beforeEach(async () => {
        ...
        container = await renderFunctionalContextTodoPage(stubTodoRepo)
