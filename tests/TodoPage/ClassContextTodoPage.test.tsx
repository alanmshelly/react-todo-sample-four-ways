...
describe('Adding a todo', () => {
    ...
    beforeEach(async () => {
        ...
        container = await renderClassContextTodoPage(stubTodoRepo)
...
function renderClassContextTodoPage(todoRepo: TodoRepo) {
    /**
     * NOTE:
     ...
     */
    return renderRoutesAtPath('/class-context', {todoRepo})
}